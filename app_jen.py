...
# # from util.custom_vision import custom_vision_predict, custom_vision_classify_moncherie
# # from util.image_helpers import draw_bb_on_img
# # from werkzeug.utils import secure_filename
# # from util.gradio_call import call_gradio_api
# # from util.transcription import whisper_transcribe
...
# # TODO: rename the index_copy.py file to index.py and delete the other one
# # @app.route('/')
# # # @login_required
# # def index():
